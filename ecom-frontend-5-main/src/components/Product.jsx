...
const Product = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        const response = await axios.get(
          `https://e-commerce-website-1-xzpr.onrender.com/api/product/${id}`
        );
    ...
    const fetchImage = async () => {
      const response = await axios.get(
        `https://e-commerce-website-1-xzpr.onrender.com/api/product/${id}/image`,
        { responseType: "blob" }
      );
  ...
  const deleteProduct = async () => {
    try {
      await axios.delete(`https://e-commerce-website-1-xzpr.onrender.com/api/product/${id}`);
      removeFromCart(id);
